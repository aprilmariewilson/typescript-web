...
},{"../views/View":"src/views/View.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Model(attributes, events, sync) {
    ...
    this.events = events;
    this.sync = sync; //if you don't have constructer you can shorten through methods
...
users.fetch();
},{"./views/UserForm":"src/views/UserForm.ts","./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts"}],"../../../.npm-global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../.npm-global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
